...
@section('content')
    ...
    <section id="pacakages" class="pacakages section-padding">
        <div class="container">
            ...
            <div class="cta">
                <a href="https://api.whatsapp.com/send?phone=6281317368610&text=Hi Lembongan Ocean Adventure, i want to ask about {{ $package->title }}" target="_blank" class="btn bg-success text-white"> <i class="fa-brands fa-whatsapp"></i> Book Now</a>
            </div>
            <hr>
