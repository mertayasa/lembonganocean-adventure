            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::model($banner, ['route' => ['banner.update', $banner->id], 'enctype' => 'multipart/form-data', 'id' => 'updateBannerForm']) !!}
                        @include('backend.banner.form')

                        <div class="mt-3">
                            <a href="{{ route('banner.index') }}" class="btn btn-sm btn-danger">Batal</a>
                            <button class="btn btn-sm btn-primary" type="button" x-on:click="$store.banner.update($event)">Simpan</button>
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>
