...
@section('content')
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Manajemen Profile</h1>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::model($user, ['route' => 'profile.update', 'enctype' => 'multipart/form-data', 'id' => 'updateProfileForm']) !!}
                        @include('backend.profile.form')

                        <div class="mt-3">
                            <button class="btn btn-sm btn-primary" type="button" x-on:click="$store.profile.update($event)">Simpan</button>
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>
